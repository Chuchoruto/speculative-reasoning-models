...
def main():
    ...
    print()
    print("Parameters:")
    print("  - draft_checkpoint_path: Path to draft model checkpoint in Modal volume")
    print("  - target_checkpoint_path: Path to target (Coconut) model checkpoint")
    print("  - data_path: Path to test data (default: 'data/gsm_test.json')")
    print("  - num_latent_thoughts: Number of latent thoughts (default: 6)")
    print("  - gamma: Number of draft tokens per round (default: 4)")
    print("  - max_new_tokens: Maximum tokens to generate (default: 50)")
    print("  - similarity_threshold: Latent thought acceptance threshold (default: 0.9)")
    print("  - max_samples: Maximum samples to evaluate (default: 100)")
    print()
